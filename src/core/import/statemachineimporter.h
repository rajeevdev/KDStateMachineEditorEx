...
#ifndef KDSME_STATEMACHINEIMPORTER_H
#define KDSME_STATEMACHINEIMPORTER_H
 ...
 */
class KDSME_CORE_EXPORT StateMachineImporter : public AbstractImporter
{
public:
    explicit StateMachineImporter(const QByteArray& data);
    virtual ~StateMachineImporter();
...
#endif // KDSME_STATEMACHINEIMPORTER_H
