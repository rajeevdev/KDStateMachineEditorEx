...
struct StateMachineImporter::Private
{
    Private(StateMachineImporter* q) : q(q) {}
...
StateMachineImporter::StateMachineImporter(const QByteArray& data)
    : d(new Private(this))
{
    d->m_data = data;
}
...
StateMachine* StateMachineImporter::import()
{
...
StateMachine* StateMachineImporter::Private::visitScxml()
{
...
void StateMachineImporter::Private::visitParallel(State* parent)
{
...
void StateMachineImporter::Private::visitState(State* parent)
{
...
void StateMachineImporter::Private::visitInitial(State* parent)
{
...
void StateMachineImporter::Private::visitFinal(State* parent)
{
...
void StateMachineImporter::Private::visitTransiton(State* parent)
{
...
void StateMachineImporter::Private::visitHistory(State* parent)
{
    Q_UNUSED(parent);
    Q_ASSERT(m_reader.isStartElement() && m_reader.name() == "transition");
    IF_DEBUG(qCDebug(KDSME_CORE) << Q_FUNC_INFO;)
...
void StateMachineImporter::Private::resolveTargetStates()
{
...
State* StateMachineImporter::Private::tryCreateInitialState(State* parent)
{
    const QXmlStreamAttributes attributes = m_reader.attributes();
...
void StateMachineImporter::Private::initState(State* state)
{
    Q_ASSERT(state);
...
Transition* StateMachineImporter::Private::createTransition(State* parent, const QString& targetStateId)
{
...
void StateMachineImporter::Private::reset()
{
...
void StateMachineImporter::Private::raiseUnexpectedElementError(const QString& context)
{
